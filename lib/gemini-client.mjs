...
- "intent": one of "search_emails", "summarize_emails", "important_emails", "action_items", "daily_report", "meeting_prep", "todays_meetings", "upcoming_meetings", "search_teams", "search_whatsapp", "general_query", "unknown"
